...
namespace ConsoleApp1
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            /*HeightmapImporter.getOpenStreetXMLBBox(new OpenTK.Vector2(48.756846f, 9.156012f),
                new OpenTK.Vector2(48.8f, 9.2f), "Heslach",4);

            var heslachFrom = new OpenTK.Vector2(48.755238f, 9.146392f);
            var heslachTo = new OpenTK.Vector2(48.767457f, 9.167524f);


            var heslachHeight = HeightmapImporter.GetOpenElevationData(heslachFrom, heslachTo, new Vector2(10, 10));
            Mapgenerator mapgen = new Mapgenerator();
            var vol = mapgen.GenerateMapFromHeightData(heslachHeight, new OpenTK.Vector2(10, 10), 20);
            engine.SetWorld(vol);
            ...
            model.Scales = new OpenTK.Vector3(0.3f);
            model.Position.Y = 30;
            model.mass = 0.1f;
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                Cube cube = new Cube(new OpenTK.Vector4(255,0,0,255));
                cube.name = "cube" + i;
                cube.Position = new OpenTK.Vector3(posx,0,posz);
                cube.mass = 0.1f;
